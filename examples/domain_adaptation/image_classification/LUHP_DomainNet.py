...
def data_load(args):
    ...
    if args.source == ['C']:
        s_dset_path = "/home/b230/data/DA/DomainNet/clipart_train_mini.txt"
    elif args.source == ['P']:
        s_dset_path = "/home/b230/data/DA/DomainNet/painting_train_mini.txt"
    elif args.source == ['R']:
        s_dset_path = "/home/b230/data/DA/DomainNet/real_train_mini.txt"
    else:
        s_dset_path = "/home/b230/data/DA/DomainNet/sketch_train_mini.txt"

    if args.target == ['C']:
        t_dset_path = "/home/b230/data/DA/DomainNet/clipart_train_mini.txt"
    elif args.target == ['P']:
        t_dset_path = "/home/b230/data/DA/DomainNet/painting_train_mini.txt"
    elif args.target == ['R']:
        t_dset_path = "/home/b230/data/DA/DomainNet/real_train_mini.txt"
    else:
        t_dset_path = "/home/b230/data/DA/DomainNet/sketch_train_mini.txt"
    print(s_dset_path)
    print(t_dset_path)
...
def main(args: argparse.Namespace):
    ...
    mem_cls_target = torch.rand(len(dset_loaders["target"].dataset), 40).to(device)
    ...
    # start training
    best_acc1 = 0.
    luhp = LUHP.MemoryTripletK_reuse(40, len(dset_loaders["target"].dataset))
...
def train(dset_loaders, train_source_iter, train_target_iter,
    ...
    class_weight_src = torch.ones(40, ).to(device)
    model.train()
    domain_adv.train()
    ...
    for i in range(args.iters_per_epoch):
        ...
        src = CrossEntropyLabelSmooth(num_classes=40, epsilon=args.smooth)(y_s, labels_s)
        ...
        # dis_1 = -torch.mm(f_t.detach(), mem_fea_target.t())
